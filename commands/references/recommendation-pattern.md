...
CFH의 인터뷰·옵션 제시·dispatch 결정에서 **빈 질문 금지, 추천 우선** 컨벤션. mattpocock의 grill-me 핵심 원칙을 프로젝트 가치에 맞게 어댑테이션한 것.
...
| `/cfh-grill` | 매 질문 | **본질** — grill-me의 핵심 | 0.14.1 |
...
다른 옵션:
   - Expert Pool — 여러 축(보안·성능·a11y) 동시 평가 필요할 때
...
- `skills/grill-me/SKILL.md` — 결정 트리 깊이 파는 전용 스킬
- `commands/cfh-grill.md` — grill-me 명시 호출
