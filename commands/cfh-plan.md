...
```
🔍 (옵션) plan side-effect Adversary 검증 가능 — /cfh-plan-audit (0.24.0+ 후보)
```

신호 약하면 *침묵* (자가검증). 0.24.0에서 별 명령 신설 여부는 외부 사용자 데이터 보고 결정.
