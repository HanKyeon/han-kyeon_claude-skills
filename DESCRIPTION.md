...
- **Phase 4 Root Cause + Fix Plan** — 근본 원인 확정 + 수정 전략 (hotfix/proper/둘 다) + 회귀 테스트 + 관찰성 강화 제안
...
**출력**: 프로젝트 루트 `REVIEW.md`. Summary 표에 Project Health·Product Impact 행 추가. `❓ Questions to Resolve` 섹션 상단에 모호 의도 분리.
