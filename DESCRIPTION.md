...
Skills (C:\Users\<you>\.claude\skills):
  asset-factory            managed@0.28.2  →  [/cfh-make]
  debug-investigator       managed@0.28.2  →  [/cfh-debug]
  grilling                 managed@0.28.2  →  [/cfh-grill]
  cfh-harness          managed@0.28.2  →  [/cfh-team]
  refactoring-strategy     managed@0.28.2  →  [/cfh-refactor, /cfh-refactor-gen]
  skill-author             managed@0.28.2  →  [/cfh-new]
  tdd-first                managed@0.28.2  →  [/cfh-tdd, /cfh-tc]
  tdd-general              managed@0.28.2  →  [/cfh-tdd-gen, /cfh-tc-gen]
...
Commands (C:\Users\<you>\.claude\commands):
  ...
  cfh-retro, cfh-review, cfh-tc, cfh-tc-gen, cfh-tdd, cfh-tdd-gen, cfh-team, cfh-trace
                                          (모두 managed@0.28.2 · *=experimental)
```
