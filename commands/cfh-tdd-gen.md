...
- 기존 파일 경로 (이미 존재) → **deprecation warning**: "/cfh-tdd-gen은 신규 작성 대상입니다. 기존 파일 보강이면 /cfh-tc-gen을 사용하세요. (0.17.x deprecation — 향후 자동 차단)" 후 사용자 yes 시 진행, 아니면 종료
...
**Team Suggestion** (조건부 출력 — `commands/references/team-suggestion.md` § A):
